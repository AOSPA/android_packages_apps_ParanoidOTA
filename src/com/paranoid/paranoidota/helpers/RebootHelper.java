...
public class RebootHelper {
        ...
        alert.setPositiveButton(R.string.alert_reboot_now, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                if (cbBackup.isChecked()) {
                    showBackupDialog(context, items, cbWipeSystem.isChecked(),
                            cbWipeData.isChecked(), cbWipeCaches.isChecked());
                } else {
                    reboot(context, items, cbWipeSystem.isChecked(), cbWipeData.isChecked(), cbWipeCaches.isChecked(), null, null);
                }
                installCursor.close();
    ...
    private void reboot(final Context context, final String[] items, final boolean wipeSystem,
            ...
            alert.setPositiveButton(R.string.alert_reboot_now,
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int whichButton) {
                            ...
                            _reboot(context, items, wipeSystem, wipeData, wipeCaches, backupFolder, backupOptions);
    ...
    private void _reboot(Context context, String[] items, boolean wipeSystem, boolean wipeData,
        ...
        try {
            ...
            int[] recoveries = new int[] { Utils.TWRP, Utils.CWM };
            ...
            for (int i = 0; i < recoveries.length; i++) {
                ...
                try {
                    ...
                    String[] commands = mRecoveryHelper.getCommands(recoveries[i], files, items,
                            wipeSystem, wipeData, wipeCaches, backupFolder, backupOptions);
                    if (commands != null) {
