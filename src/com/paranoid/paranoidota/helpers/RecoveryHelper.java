...
public class RecoveryHelper {
    ...
    public RecoveryHelper(Context context) {
        ...
        recoveries.put(Utils.CWM, new CwmBasedRecovery(context));
        recoveries.put(Utils.TWRP, new TwrpRecovery());
    }
    ...
    public String[] getCommands(int id, String[] items, String[] originalItems, boolean wipeSystem,
