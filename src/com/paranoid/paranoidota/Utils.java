...
public class Utils {
    ...
    /**
     * Method borrowed from OpenDelta Credits to Jorrit "Chainfire" Jongma and
     * The OmniROM Project Using reflection voodoo instead calling the hidden
     * class directly, to dev/test outside of AOSP tree
     */
